...
\subsection{Layered Poiseuille flow}
\label{sec:layered}
...
\subsection{A floating body: Archimedes and the metacentre}
\label{sec:floating}
...
%==============================================================================
\section{Thermal benchmarks of Zhou, De Rosis and Revell (2026)}
\label{sec:zhou}

The suite of \S\ref{sec:campaign} is a fluid-only campaign. This section works
...
%------------------------------------------------------------------------------
\subsection{A convergence criterion that was wrong by two orders of magnitude}
\label{sec:zhoudrift}
...
%------------------------------------------------------------------------------
\subsection{3.1 Conjugate heat conduction: exact}
...
%------------------------------------------------------------------------------
\subsection{3.4 Normal plate velocity: second order, and a hypothesis that died}
...
%------------------------------------------------------------------------------
\subsection{3.2 Natural convection in a square cavity}
\label{sec:zhounat2d}
...
%------------------------------------------------------------------------------
\subsection{3.5 Thermal lid-driven cavity, and two conclusions drawn too early}
\label{sec:zhoulid}
...
%------------------------------------------------------------------------------
\subsection{3.6 Natural convection in a cubic cavity}
\label{sec:zhounat3d}
